...
export default function atvImg(withCircles: boolean = false) {
  var d = document,
  ...
  for (var l = 0; l < totalImgs; l++) {
    ...
    var containerHTML = d.createElement('div'),
      ...
      circleTopHTML = d.createElement('div'),
      circleBottomHTML = d.createElement('div'),
      layers = [];
    ...
    if (withCircles) {
      containerHTML.appendChild(circleTopHTML);
      containerHTML.appendChild(circleBottomHTML);
    }
